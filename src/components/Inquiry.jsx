...
const ConsultationForm = ({ setShowForm }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-gray-900 text-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        {message && <p className="text-center text-white bg-gray-700 p-2 rounded">{message}</p>}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="button" onClick={() => setShowForm(false)} 
            className="w-full mt-2 bg-red-500 text-white font-semibold py-2 rounded-md hover:bg-red-600 transition">
            Cancel
          </button>
        </form>
      </div>
